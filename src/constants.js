...
export const STATUS_LIST = ['대기','진행','완료','검토완료']
export const STATUS_STYLE = {
  ...
  '검토완료':{ color:'#94a3b8', bg:'rgba(148,163,184,0.1)', border:'rgba(148,163,184,0.25)'},
}

export const ACCOUNTS = [
  { id:'boss',    name:'찬', role:'admin'  },
...
export const PASSWORD_HASHES = {
  ...
  pilseon: '1fef73e2272a1199fbce52f932134938c44ed5fcadd593bb8253cb8574fb77ab',
}

export const DEFAULT_PERMS = {
  jinsu:   { dev:{view:true,edit:true}, design:{view:false,edit:false}, marketing:{view:false,edit:false}, ops:{view:false,edit:false}, info:{view:true} },
  pilseon: { dev:{view:true,edit:true}, design:{view:false,edit:false}, marketing:{view:false,edit:false}, ops:{view:false,edit:false}, info:{view:true} },
}

export const ADMIN_PERMS = {
  dev:{view:true,edit:true}, design:{view:true,edit:true}, marketing:{view:true,edit:true}, ops:{view:true,edit:true}, info:{view:true,edit:true},
}
