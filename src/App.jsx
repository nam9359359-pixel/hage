...
async function initFirestore() {
  ...
  for (const acc of ACCOUNTS) {
    ...
    if (!snap.exists()) {
      await setDoc(ref, { id: acc.id, name: acc.name, role: acc.role, passwordHash: PASSWORD_HASHES[acc.id] })
    }
  }
  // Init permissions
...
export default function App() {
  ...
  switch (route.page) {
    ...
    case 'calendar':     return user.role==='admin' ? <CalendarPage {...props} /> : <MainPage {...props} />
